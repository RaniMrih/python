...
Dwell_List=[]
SumSegment_List=[]
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1185'
...
print
print (GREEN + ":::::::::::::::::::::::::::::::::::::::::::::::::: Running TC_2.3.1 Step 1185 , Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" + RESET )
time.sleep(1)
#------------------------------------- Functions -------------------------------------
def YesNo(YN):
   if YN == True:
...
def BinDwellSum():
   sum=0
   for line in open(TC_start + "/S2.3.1Sino.txt", "r"):
     line = line.rstrip()
...
def SumSegment():
   ...
   for i in range (30):
     if i < 10:
       for line in open(TC_start + "/Tell2.3.1.SINO000"+str(i), "r"):
         line = line.rstrip()
         if re.search('DS 0 Total Counts:', line):
           SumSegment_List.append(line)
     if i >10 and i <20:
       for line in open(TC_start + "/Tell2.3.1.SINO00"+str(i), "r"):
         line = line.rstrip()
         if re.search('DS 0 Total Counts:', line):
           SumSegment_List.append(line)
     if i > 19:
...
TotalPromptsReplay = Find_In_Sino("/S2.3.1Sino.txt" , "statsData.totalPrompts:")
for i in range (3):
...
FrameDurationReplay = Find_In_Sino("/S2.3.1Sino.txt" , "Frame Duration")
for i in range (3):
...
print
print "Creating Tell2.3.1.SINO0000 - SINO0029, Please Wait..."
os.system("rdfTeller -r '-h f -S' -f Tell2.3.1 "+SinosDirectory2_3_1+"/SINO*")
# ------------------------------------ step 2 --------------------------------------------
#----------- qustion ---------
time.sleep(1)
print
...
time.sleep(1)
Step_Result("Acq4D.1185")

os.system("chmod +x /usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1363/Acq4D_1363.py")
os.system("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1363/Acq4D_1363.py")
