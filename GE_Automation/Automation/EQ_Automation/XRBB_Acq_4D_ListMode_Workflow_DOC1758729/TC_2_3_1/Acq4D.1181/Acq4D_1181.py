...
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1181'
...
print
print (GREEN + ":::::::::::::::::::::::::::::::::::::::::::::::::: Running TC_2.3.1 Step 1181 , Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" + RESET )
time.sleep(1)
#------------------------------------- Functions -------------------------------------
def YesNo(YN):
   if YN == True:
...
#----------- qustion ---------
time.sleep(1)
print (BLUE + "2) S2.3.1Sino.txt file data : " +RESET)
print
...
Time2=ScanStartSINOLive[0].replace(ScanStartSINOLive[0][:11],'')
...
time.sleep(1)
Step_Result("Acq4D.1181")

os.system("chmod +x /usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1182/Acq4D_1182.py")
os.system("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1182/Acq4D_1182.py")
