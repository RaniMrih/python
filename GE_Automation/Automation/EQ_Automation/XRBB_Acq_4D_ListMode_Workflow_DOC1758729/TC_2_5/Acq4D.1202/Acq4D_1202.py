...
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_5/Acq4D.1202'
...
print "[ ] Yes"
print "[ ] No"
print (YELLOW + 'NOTE :Files Block_Busy_Max_Live/Replay.txt located at: ~/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_5/Acq4D.1202' + RESET)

#-- determine if step Pass/Fail
time.sleep(1)
print
Step_Result("Acq4D.1202")
print (GREEN +"                                                       ---- END of TC 2.5 for XRBB ----" +RESET)
