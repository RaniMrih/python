...
Dwell_List=[]
SumSegment_List=[]
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_2/Acq4D.1422'
...
print
print (GREEN + ":::::::::::::::::::::::::::::::::::::::::::::::::: Running TC_2.3.2 Step 1422 , Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" + RESET )
time.sleep(1)
#------------------------------------- Functions -------------------------------------
def YesNo(YN):
   if YN == True:
...
Replay = Find_In_Sino("/S2.3.2Sino.txt" ,"Block Busy Average Deadtime" )
...
time.sleep(1)
Step_Result("Acq4D.1422")
print
print (GREEN +"                                                       ---- END of TC 2.3.2 for XRBB ----" +RESET)
