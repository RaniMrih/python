...
Max_List_Loss=[]
Sorter_Loss_csv=[]
TC_start='/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_16_2/Acq4D.1410'
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_16_2/Acq4D.1411'

print (GREEN + ":::::::::::::::::::::::::::::::::::::::::::::::::: Running TC_2.16.2 Step 1411 , Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" + RESET )
...
# ------------------------------------ step 1 --------------------------------------------
# grep sinos  path
f = open( TC_start +"/SINOSPath2_16_2.txt" , "r")
for line in f:
  SinosPath = line

print "Creating coinLoss_1411.csv, please wait..."
...
# ------------------------------------ step 2 --------------------------------------------
# grep sinos  path
f = open( TC_start +"/LISTSPath2_16_2.txt" , "r")
for line in f:
  ListsPath = line

#perform ListTool to 9 Listfile from TC2.16.2
...
print "[ ] Yes"
print "[ ] No"
print (YELLOW + 'NOTE: Use ListToolPlot.py to create a plot of the ListLoss.csv for each frame, and label as "SSVP.PAC.Acq4D.1411"' + RESET)
print
#-- determine if step Pass/Fail

time.sleep(1)
Step_Result("Acq4D.1411")
print (GREEN +"                                                        ---- END of TC 2.16.2 for XRBB ----" +RESET)
