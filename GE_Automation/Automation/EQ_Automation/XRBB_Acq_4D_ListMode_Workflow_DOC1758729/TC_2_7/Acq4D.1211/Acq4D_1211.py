...
LiveTotal=[]
ReplayTotal=[]
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_7/Acq4D.1211'
...
def ReplayTotalPrompts():
   for i in sinosList2_7:
     for line in open("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_7/Acq4D.1209/Tell2.7", "r"):
       line = line.rstrip()
...
def ListFileTotalPrompts():
   for i in sinosList2_7:
     for line in open("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_4/Acq4D.1190/ListLoss2.4.txt", "r"):
       line = line.rstrip()
...
print (GREEN +"                                                        ---- END of TC 2.7 for XRBB ----" +RESET)
