...
Loss_In_Aligned=[]
Max_List_Loss=[]
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1290'
...
print "[ ] Yes"
print "[ ] No"
print (YELLOW + 'NOTE: LT_ConcurListCopy_1284.csv located at: ~/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1290' + RESET)
print
#-- determine if step Pass/Fail
time.sleep(1)
Step_Result("Acq4D.1290")

os.system("chmod +x /usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1291/Acq4D_1291.py")
os.system("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1291/Acq4D_1291.py")
