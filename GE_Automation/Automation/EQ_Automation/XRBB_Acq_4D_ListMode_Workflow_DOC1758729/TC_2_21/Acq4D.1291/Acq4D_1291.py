...
Loss_In_Aligned=[]
Max_List_Loss=[]
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1291'
TC_start='/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1287'

print (GREEN + ":::::::::::::::::::::::::::::::::::::::::::::::::: Running TC_2.21 Step 1291 , Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" + RESET )
print
time.sleep(1)
#------------------------------------- Functions -------------------------------------
def YesNo(YN):
...
def findPercentMissing():
   for line in open(PWD + "/LT_Ml.ConcurListCopy_1285.txt", "r"):
      line = line.rstrip()
...
def findMaxListLossPerSec():
   ...
   i=0
   f = open( PWD + "/LT_ConcurListCopy_1285.csv", "r")
...
# ------------------------------------ step 1 --------------------------------------------
# grep list file path
f = open( TC_start + "/LISTSPath2_21_2.txt" , "r")
for line in f:
  path = line

print "Creating NewList_ConcurListCopy_1285.BLF, please wait..."
os.system("ln -sf " + path + "/LIST0000.BLF > NewList_ConcurListCopy_1285.BLF")
os.system("cp LIST0000.BLF " + PWD)
os.system("cp NewList_ConcurListCopy_1285.BLF " + PWD)
#----------------------------

print ("Creating LT_Ml.ConcurListCopy_1285.txt, LT_ConcurListCopy_1285.csv for ListFile, please wait...")
os.system("ListTool -Ml -f LT_ConcurListCopy_1285.csv LIST0000.BLF > LT_Ml.ConcurListCopy_1285.txt")
os.system("cp LT_ConcurListCopy_1285.csv " + PWD)
os.system("cp LT_Ml.ConcurListCopy_1285.txt " + PWD)
...
print "[ ] Yes"
print "[ ] No"
print (YELLOW + 'NOTE: LT_ConcurListCopy_1285.csv located at: ~/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1291' + RESET)
print
#-- determine if step Pass/Fail
time.sleep(1)
Step_Result("Acq4D.1291")
print (GREEN +"                                                        ---- END of TC 2.21 for XRBB ----" +RESET)
