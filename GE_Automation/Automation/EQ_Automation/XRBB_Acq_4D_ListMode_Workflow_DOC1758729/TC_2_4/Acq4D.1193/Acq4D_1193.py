...
RED = '\33[31m'
YELLOW = '\33[33m'
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_4/Acq4D.1193'
...
os.system("cp ~/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_4/Acq4D.1189/Tell2.4* " +PWD)
...
f = open("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_4/Acq4D.1189/ListLoss2.4.txt","r")
for line in f:
  if "Delta" in line:
    line1=line.rstrip('\n')
...
print (BLUE + "Total Prompts"+ RESET)
f = open("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_4/Acq4D.1189/ListLoss2.4.csv", "r")
for line in f:
...
print (GREEN +"                                                       ---- END of TC 2.4 for XRBB ----" +RESET)
#--------END TC2.4
