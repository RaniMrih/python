...
Table_Live=[]
Table_Replay=[]
PWD = '/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_2/Acq4D.1166'
...
if os.stat(TC_start+"/SSVP.1166.objE.txt").st_size > 0:
  ...
  YesNo(True)
  print (YELLOW + 'NOTE: SSVP.1166.objE.txt located at: ~/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_2/Acq4D.1166' + RESET)
else:
  YesNo(False)
...
os.system("chmod +x /usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_2/Acq4D.1167/Acq4D_1167.py")
os.system("/usr/g/ctuser/EQ_Automation/XRBB_Acq_4D_ListMode_Workflow_DOC1758729/TC_2_2/Acq4D.1167/Acq4D_1167.py")
