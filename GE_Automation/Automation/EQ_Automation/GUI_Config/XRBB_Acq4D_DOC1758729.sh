...
echo $zenity_LIST_Input1 > /usr/g/ctuser/EQ_Automation/User_Input_LIST1.txt
  ...
  zenity_choose_TC=$(
  zenity --radiolist --list --title="Choose TC to run XRBB - Acq4D_DOC1758729" --width="800" --height="750" \
  ...
  "" "TC 2.11" "Galilio" "No Automation"\
  "" "TC 2.12" "Galilio" "No Automation"\
  "" "TC 2.13" "Galilio" "No Automation"\
...
TC="TC__2.1"
chmod +x $XRBB_Acq4D_Path/TC_2_1/Acq4D.1154/Acq4D_1154.py
cd $XRBB_Acq4D_Path/TC_2_1/Acq4D.1154/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_1/Acq4D.1154/Acq4D_1154.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.2 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.2" ]]; then
TC="TC_2.2"
chmod +x $XRBB_Acq4D_Path/TC_2_2/Acq4D.1165/Acq4D_1165.py
cd $XRBB_Acq4D_Path/TC_2_2/Acq4D.1165/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_2/Acq4D.1165/Acq4D_1165.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.3.1 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.3.1" ]]; then
TC="TC_2.3.1"
chmod +x $XRBB_Acq4D_Path/TC_2_3_1/Acq4D.1179/Acq4D_1179.py
cd $XRBB_Acq4D_Path/TC_2_3_1/Acq4D.1179/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_3_1/Acq4D.1179/Acq4D_1179.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
...
TC="TC_2.3.2"
chmod +x $XRBB_Acq4D_Path/TC_2_3_2/Acq4D.1448/Acq4D_1448.py
cd $XRBB_Acq4D_Path/TC_2_3_2/Acq4D.1448/
User_Input_SINO_Function $TC
User_Input_SINO_Function1 $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_3_2/Acq4D.1448/Acq4D_1448.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.4 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.4" ]]; then
TC="TC_2.4"
chmod +x $XRBB_Acq4D_Path/TC_2_4/Acq4D.1189/Acq4D_1189.py
cd $XRBB_Acq4D_Path/TC_2_4/Acq4D.1189/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_4/Acq4D.1189/Acq4D_1189.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.5 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.5" ]]; then
TC="TC_2.5"
chmod +x $XRBB_Acq4D_Path/TC_2_5/Acq4D.1196/Acq4D_1196.py
cd $XRBB_Acq4D_Path/TC_2_5/Acq4D.1196/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_5/Acq4D.1196/Acq4D_1196.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.6 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.6" ]]; then
TC="TC_2.6"
chmod +x $XRBB_Acq4D_Path/TC_2_6/Acq4D.1204/Acq4D_1204.py
cd $XRBB_Acq4D_Path/TC_2_6/Acq4D.1204/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_6/Acq4D.1204/Acq4D_1204.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.7 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.7" ]]; then
TC="TC_2.7"
chmod +x $XRBB_Acq4D_Path/TC_2_7/Acq4D.1209/Acq4D_1209.py
cd $XRBB_Acq4D_Path/TC_2_7/Acq4D.1209/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_7/Acq4D.1209/Acq4D_1209.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.8 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.8" ]]; then
TC="TC_2.8"
chmod +x $XRBB_Acq4D_Path/TC_2_8/Acq4D.1328/Acq4D_1328.py
cd $XRBB_Acq4D_Path/TC_2_8/Acq4D.1328/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_8/Acq4D.1328/Acq4D_1328.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.9 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.9" ]]; then
TC="TC_2.9"
chmod +x $XRBB_Acq4D_Path/TC_2_9/Acq4D.1215/Acq4D_1215.py
cd $XRBB_Acq4D_Path/TC_2_9/Acq4D.1215/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_9/Acq4D.1215/Acq4D_1215.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.10 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.10" ]]; then
TC="TC_2.10"
chmod +x $XRBB_Acq4D_Path/TC_2_10/Acq4D.1223/Acq4D_1223.py
cd $XRBB_Acq4D_Path/TC_2_10/Acq4D.1223/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_10/Acq4D.1223/Acq4D_1223.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.14 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.14" ]]; then
TC="TC_2.14"
chmod +x $XRBB_Acq4D_Path/TC_2_14/Acq4D.1242/Acq4D_1242.py
cd $XRBB_Acq4D_Path/TC_2_14/Acq4D.1242/
User_Input_SINO_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_14/Acq4D.1242/Acq4D_1242.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.16.1 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.16.1" ]]; then
TC="TC_2.16.1"
chmod +x $XRBB_Acq4D_Path/TC_2_16_1/Acq4D.1318/Acq4D_1318.py
cd $XRBB_Acq4D_Path/TC_2_16_1/Acq4D.1318/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_16_1/Acq4D.1318/Acq4D_1318.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.16.2 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.16.2" ]]; then
TC="TC_2.16.2"
chmod +x $XRBB_Acq4D_Path/TC_2_16_2/Acq4D.1410/Acq4D_1410.py
cd $XRBB_Acq4D_Path/TC_2_16_2/Acq4D.1410/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_16_2/Acq4D.1410/Acq4D_1410.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.17 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.17" ]]; then
TC="TC_2.17"
chmod +x $XRBB_Acq4D_Path/TC_2_17/Acq4D.1272/Acq4D_1272.py
cd $XRBB_Acq4D_Path/TC_2_17/Acq4D.1272/
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_17/Acq4D.1272/Acq4D_1272.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
#-------------------------------- run TC 2.20 according to baseline document XRBB ------------------------------
if [[ $zenity_choose_TC == "TC 2.20" ]]; then
TC="TC_2.20"
chmod +x $XRBB_Acq4D_Path/TC_2_20/Acq4D.1282/Acq4D_1282.py
cd $XRBB_Acq4D_Path/TC_2_20/Acq4D.1282/
User_Input_SINO_Function $TC
User_Input_LIST_Function $TC
script -c $XRBB_Acq4D_Path/TC_2_20/Acq4D.1282/Acq4D_1282.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
...
TC="TC_2.21"
chmod +x $XRBB_Acq4D_Path/TC_2_21/Acq4D.1287/Acq4D_1287.py
cd $XRBB_Acq4D_Path/TC_2_21/Acq4D.1287/
User_Input_SINO_Function $TC
User_Input_SINO_Function1 $TC
User_Input_LIST_Function $TC
User_Input_LIST_Function1 $TC
script -c $XRBB_Acq4D_Path/TC_2_21/Acq4D.1287/Acq4D_1287.py $EQ_Path/Tmp_Log.log
#-- go to clean logs function and finish popup function
Clean_Logs_function
Finish_Function $TC
fi
