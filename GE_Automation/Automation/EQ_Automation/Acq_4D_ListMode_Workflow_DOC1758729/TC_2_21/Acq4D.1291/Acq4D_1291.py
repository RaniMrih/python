...
Loss_In_Aligned=[]
Max_List_Loss=[]
PWD = '/usr/g/ctuser/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1291'
...
print "[ ] Yes"
print "[ ] No"
print (YELLOW + 'NOTE: LT_ConcurListCopy_1285.csv located at: ~/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_21/Acq4D.1291' + RESET)
print
#-- determine if step Pass/Fail
time.sleep(1)
Step_Result("Acq4D.1291")
print (GREEN +"                                                      ---- END of TC 2.21 Columbia DMI ----" +RESET)
