...
ReplayCoincList=[]
Step_Pass=True
PWD = '/usr/g/ctuser/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_6/Acq4D.1206'
...
os.system("cp ~/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_6/Acq4D.1204/coinLoss.csv " +PWD)
...
print "[ ] Yes"
print "[ ] No"
print (YELLOW + 'NOTE: coinLoss.csv located at: ~/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_6/Acq4D.1206' + RESET)

#-- determine if step Pass/Fail
time.sleep(1)
Step_Result("Acq4D.1206")
print (GREEN +"                                                      ---- END of TC 2.6 Columbia DMI ----" +RESET)
