...
Clean_Logs_function (){
Tmp="$EQ_Path/Tmp_Log.log"
Tmp1="$EQ_Path/NewFile.txt"
FinalLog="$EQ_Path/Automation_Log.log"
# commands to clean
...
zenity_choose_document=$(
        zenity --radiolist --list --title="Choose Document to run" --width="800" --height="750" --ok-label="Start Automation" --cancel-label="Go Back"\
...
script -c "python $EQ_Path/execute_wrapper.py $zenity_choose_document $zenity_choose_TC" Tmp_Log.log
